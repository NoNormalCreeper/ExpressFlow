...
TEST(ParcelTest, NewParcelStartsWaitingForPickupWithItemDetails) {
    ...
    EXPECT_EQ(parcel.itemType(), ParcelItemType::Standard);
...
TEST(ParcelTest, ParcelStartsWaitingForPickupWithItemDetails) {
    const Parcel parcel = Parcel::createWaitingForPickup(
        "P-2001",
        "alice",
        "bob",
...
TEST(ParcelTest, ParcelRecordsCourierAssignmentAndPickup) {
    Parcel parcel = Parcel::createWaitingForPickup(
        "P-2002",
        "alice",
        "bob",
